    ...
    <>
      ...
      <div className="px-6 md:px-12 lg:px-20 py-12 bg-gradient-to-br from-white to-orange-50 min-h-screen">
        ...
        <div className="flex flex-col lg:flex-row gap-8 max-w-4xl mx-auto">
          ...
          {/* Contact Info */}
          <div className="flex-1 max-w-sm bg-orange-50 border border-orange-300 rounded-2xl shadow-lg p-8 space-y-6 lg:mt-0 mt-10 mx-auto lg:mx-0 lg:text-left text-center pl-6 sm:pl-10">
