...
import { HomeIcon, ShoppingBag } from "lucide-react"; // ✅ Imported icon to fix BagIcon error
import { BoxIcon } from "lucide-react"; // ✅ Imported BoxIcon for products
          ...
          <>
            <UserButton>
              ...
              <UserButton.MenuItems>
                <UserButton.Action
                  label="My Orders"
                  labelIcon={<ShoppingBag />} // ✅ Replaced BagIcon
                  onClick={() => router.push("/my-orders")}
                />
              </UserButton.MenuItems>
            </UserButton>
